...
<script type="text/javascript" src="pages/sys/index/jsp/userActivity/js/deleteTopic.js"></script>
<title>帖子</title>
</head>
<body>
	<%
		...
		for(int i=0;i<list.size();i++){
			...
			out.print("<button id="+'"'+"btn"+i+'"'+"onclick="+'"'+"Delete()"+'"'+" class="+'"'+"delete_btn"+'"'+">删除</button>");
			out.print("</div>");
